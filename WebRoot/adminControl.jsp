...
.zebra tr {
  ...
  <body>
   ...
   <table class="zebra" style="height: 267px; width: 471px; ">
   	 <caption><center>Admin Mange</center></caption>
   <tbody>
  <tr>
    <th><s:a href="adminBookMange.jsp">Mange Book</s:a></th>
    <th><s:a href="adminOrderMange.jsp">Mange Order</s:a></th>
    <th><s:a href="listUser.action">User List</s:a></th>
   </tr>
   </tbody>
   </table>
   </div>
